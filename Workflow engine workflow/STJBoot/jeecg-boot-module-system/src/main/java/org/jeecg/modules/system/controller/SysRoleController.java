...
public class SysRoleController {
	...
	@ApiOperation("/通过userId查询角色名称")
	public String getRoleNameByUserId(@PathVariable String userId){
		String roleId = sysUserRoleService.getRoleNameByUserId(userId);
		log.info("RoleId  ======================>" +roleId);
		return sysRoleService.getOne(new LambdaQueryWrapper<SysRole>().eq(SysRole::getId,roleId)).getRoleName();
