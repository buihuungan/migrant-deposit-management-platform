...
public interface SysUserMapper extends BaseMapper<SysUser> {
	...
	public String getUserNameByOpenId(String open_id);
	public SysUser getUserByUserId(@Param("userId") String userId);
//	public SysUser getUserByWorkNo(@Param("workNo") String workNo);
