package com.wust.businessback.constant;
...
public interface CommonConstant {
    ...
    /**
     * {@code 400 Not Found} (HTTP/1.0 - RFC 1945)
     */
    public static final Integer SC_NOT_FOUND_400 = 400;

    /**
     * {@code -1 Result Fail} (HTTP/1.0 - RFC 1945)
     */
    public static final Integer SC_RESULT_FAIL = -1;
     ...
     * 流程相关的常量
     */
    public static final String START_PROCESS_FAILURE = "开启流程失败";

    /**
     * 任务相关的常量
     */
    public static final String WITHDRAW_TASK_FAILURE = "撤回到上一任务节点失败";
     ...
     * 角色名称
     */
    public final static String TEACHER = "教学岗";
