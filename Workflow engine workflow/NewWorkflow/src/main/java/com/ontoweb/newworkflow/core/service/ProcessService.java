...
/**
 * @author ：Ethan yan
 * @date ：Created in 2021/7/28 上午10:17
 * @description：流程相关业务类
 * @modified By：
 * @version: $
 */
...
public interface ProcessService {
    ...
    /**
     * 从一个文件流中部署一个新的流程模版
     * @param inputJson json文件
     * @return 部署成功后的流程模版对象
     */
    ProcessDefinition deployProcess(JSONObject inputJson);

    /**
     * 更新一个流程模版，用指定InputStream中包含的流程模版对象来替换指定ID的流程模版对象
     * @param inputJson 新的流程模版流对象
     * @param processId 要替换的目标流程模版ID
     * @return 更新成功后的流程模版对象
     */
    ProcessDefinition deployProcess(JSONObject inputJson,long processId);
