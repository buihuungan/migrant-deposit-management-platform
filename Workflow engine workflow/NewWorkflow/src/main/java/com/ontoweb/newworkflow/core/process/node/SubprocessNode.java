...
import com.ontoweb.newworkflow.core.command.impl.StartProcessInstanceCommand;
...
/**
 * @author ：Ethan yan
 * @date ：Created in 2021/7/30 下午4:07
 * @description：
 * @modified By：
 * @version: $
 */
public class SubprocessNode extends Node{
    ...
    public boolean enter(Context context, ProcessInstance processInstance) {
        ...
        startProcessInstanceCommand.StartProcessInstanceCommand(subprocess,variables,startProcessInfo,processInstance.getId());
        return false;
    }
    @Override
