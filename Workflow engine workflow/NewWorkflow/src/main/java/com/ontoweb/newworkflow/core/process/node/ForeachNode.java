...
import com.ontoweb.newworkflow.core.process.handler.ForeachHandler;
...
/**
 * @author ：Ethan yan
 * @date ：Created in 2021/7/30 下午4:04
 * @description：
 * @modified By：
 * @version: $
 */
public class ForeachNode extends Node{
    ...
    private void createSubprocessInstance(Context context,ProcessInstance processInstance,Collection<Object> coll) {
        for(Object obj:coll){
            ...
            saveProcessInstanceVariablesCommand.saveProcessInstanceVariablesCommand(subProcessInstance, variables);
