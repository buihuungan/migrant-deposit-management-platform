...
(function() {
	...
	mxGraphView.prototype.validateBackgroundPage = function() {
		var useCssTranforms = this.graph.useCssTransforms; var scale = this.scale
	...
	mxGraph.prototype.updatePageBreaks = function(visible, width, height) {
		var useCssTranforms = this.useCssTransforms; var scale = this.view.scale
...
Graph.prototype.connectVertex = function(source, direction, length, evt, forceClone, ignoreCellAt) {
	ignoreCellAt = (ignoreCellAt) || false
...
if (typeof mxVertexHandler !== 'undefined') {
	(function() {
		 ...
		 */
		Graph.prototype.defaultEdgeStyle = { 'edgeStyle': 'orthogonalEdgeStyle',
'rounded': '0',
			'jettySize': 'auto',
'orthogonalLoop': '1' }
