...
mxEditor.prototype.save = function(
  ...
  if (url != null && url.length > 0) {
    ...
    var waredomain = function() {
      _this.getDiagram(`${VUE_APP_API_BASE_URL}/online/cgform/api/getData/1464fd461cf84acfa700ca4b40294b1d`, function(
        res
      ) {
        if (res.success && res.result) {
    ...
    if (!marksbox) {
      ...
      this.getDiagram(`${VUE_APP_API_BASE_URL}/online/cgform/api/getData/474400feca3a4ac4a40549b57788b6ad`, function(
        res
      ) {
        if (res.success && res.result) {
          const { records } = res.result
  ...
  if (mxUtils.isNode(value) && !model.isEdge(cell) && model.isVertex(cell)) {
    ...
    if (model.isConnectable(cell)) {
      ...
      var getPerson = function() {
        _this.getDiagram(`${VUE_APP_API_BASE_URL}/sys/role/list`, function(res) {
          if (res.success && res.result) {
            const { records } = res.result
      ...
      // 此处还需要调组件接口
      this.getDiagram(`${VUE_APP_API_BASE_URL}/online/cgform/api/getData/dfa71e6082044ec59a8f5dda5a7e9695`, function(
        res
      ) {
        if (res.success && res.result) {
          const { records } = res.result
