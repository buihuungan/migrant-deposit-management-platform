...
export default {
  ...
  methods: {
    ...
    handleChangeInTableSelect(selectedRowKeys, selectionRows) {
      ...
      console.log('selectedRowKeys', selectedRowKeys, 'selectionRows', selectionRows)
      if (!selectedRowKeys || selectedRowKeys.length == 0) {
        ...
        for (let i = 0; i < selectionRows.length; i++) {
          console.log('this.combineRowKey(selectionRows[i])', this.combineRowKey(selectionRows[i]))
    ...
    combineRowKey(record) {
      let res = ''
      console.log('combineRowKey----record接收', record)
      ...
      console.log('combineRowKey----res返回', res)
      return res
    },
