    ...
    <div class="article-table">
      ...
      >
        ...
        >
          ...
          <a-divider type="vertical" />
          <a
            :disabled="record.order_status === 2 || record.order_status === 0"
            @click="receivingGoods(record)"
          >收货</a>
          <a-divider type="vertical" />
          <a-popconfirm
...
<script>
import deliverMaterialRecord from './modules/deliverMaterialRecord'
