<template>
  <div class="main user-layout-register">
    ...
    <a-form ref="formRegister" :autoFormCreate="(form)=>{this.form = form}" id="formRegister">
      ...
      <a-form-item
        fieldDecoratorId="school"
        :fieldDecoratorOptions="{rules: [{ required: true, message: '请输入正确的租户' }], validateTrigger: ['change', 'blur'], validateFirst: true}">
        <a-input size="large" type="text" autocomplete="false" placeholder="租户名"></a-input>
      </a-form-item>
      <a-form-item
        fieldDecoratorId="role"
        :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择真实身份' }], validateTrigger: ['change', 'blur'], validateFirst: true}">
        <a-select size="large" placeholder="请选择真实身份">
