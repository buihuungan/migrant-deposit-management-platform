        ...
        <div class="panel-body">
          <el-form ref="form" :model="form">
            <div class="form-group form-control-medium">
              <label for="tip">表单提示字：</label>
              <el-input v-model="form.fieldText" id="tip" name="tip" type="text" class="form-control"></el-input>
            </div>
            <div class="form-group form-control-medium">
              <label for="field">字段名称：</label>
              <el-input v-model="form.fieldName" id="field" name="field" type="text" class="form-control"></el-input>
            </div>
            <div class="form-group form-control-medium">
            ...
            <div class="form-group form-control-small">
              ...
              <el-input v-model="form.maxLength" id="clicks" name="clicks" type="number" class="form-control"></el-input>
            </div>
          </el-form>
        </div>
      </section>
...
export default {
  ...
  methods:{
    ...
    handleOk(){
      c_postAction('/cms/admin/field/add', this.form).then(
