<template>
  <div>
    <el-card>
      ...
      <!-- <iframe :src="src" frameborder='0' style="width:800px;height:600px"></iframe> -->
    </el-card>
  </div>
</template>
<script>
...
export default {
  data() {
    return {
      src: './static/kaimu/waveFilter.html',
      detailVisiable1: false,
      detailVisiable: true,
      argProcessFlag: '88.343.000005/MABOM/_FG5.972.0987_P1.6',
      DocList: [],
      classURL: "",
      workMessage: '',
      isStuding: false,
