...
export default class PurchaseNode extends BaseNode{
    constructor(){
        super();
    ...
    buildTaskXml(nodeInfo){
        ...
        xml+=` url="${this.formflag.url}#${this.formflag.templateld}#${this.formflag.isTable}" `;
        xml+='>';
        ...
        //console.log(this.assignees.length);

        // if(this.formflag){
        //     xml+=`<formflag url="${this.formflag.url}#${this.formflag.templateld}#${this.formflag.isTable}" />`;
        // }
