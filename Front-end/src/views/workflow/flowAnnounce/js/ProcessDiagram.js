...
_buildDiagram(diagram,container){
    var nodes={};
    console.log("qqq1",diagram);
    this.paper=new Raphael(container,diagram.width, diagram.height);
    console.log("sdefr");
...
_buildConnection(fromNode,toNode,flow){
...
_buildNode(nodeDiagram,showTime){
    var width=nodeDiagram.width;
    var height=nodeDiagram.height;
    var icon=nodeDiagram.icon;
    icon="/apilocal/uflo/res"+icon;
    //  icon = '../../../../static/img/position.png'
    ...
    var time=this._buildTime(nodeDiagram.time);
    var text,image;
...
_buildTextUnderline(textElement) {
...
// console.log("ncsj",ProcessDiagram);
const a =2
export default
    ProcessDiagram
