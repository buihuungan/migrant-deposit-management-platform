  ...
  export default {
    ...
    data() {
      return {
        ...
        currentTableName:"",
        url: {
          getQueryInfo:'/cgform/api/getQueryInfo/',
          getColumns: '/cgform/api/getColumns/',
          getData: '/cgform/api/getData/',
          optPre:"/cgform/api/form/",
          exportXls:'/cgform/api/exportXls/',
          buttonAction:'/cgform/api/doButton',
    ...
    methods: {
      ...
      getImportUrl(){
        return '/cgform/api/importXls/'+this.code
      },
