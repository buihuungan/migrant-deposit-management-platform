<template>
  <a-modal :visible="visible" :centered="true" :footer="null" width="95%" :zIndex="100" :dialog-style="{ top: '20px' }"
    ...
    <div v-if="approve2">
      ...
      <div style="margin-top: 20px" v-model="rollbackForm">
        <rollback-task @close-approveRollTask="close" :formId="rollbackForm.prevForm_designer_id"
          :tableId="rollbackForm.prevOnline_table_id" :dataId="rollbackForm.prevOnline_data_id"
          :taskId="taskId"></rollback-task>
      </div>
