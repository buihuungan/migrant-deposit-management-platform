  ...
  <div>
    ...
    >
      <div v-if="easyFlowVisible" id="easyflow">
        ...
        <saveMessage ref="saveMessage" :data="data" :org_code="org_code"></saveMessage>
      </div>
    </a-modal>
  </div>
</template>
...
import nodeMenu from '@/views/easyflow/ef/node_menu'
import FlowInfo from '@/views/easyflow/ef/info'
import FlowHelp from '@/views/easyflow/ef/help'
      ...
      switch (type) {
        case 'swinlane':
          var node = {
            ...
            width: nodeMenu.width,
            height: nodeMenu.height,
          }
          break
        case 'rectangle':
          var node = {
            ...
            role: nodeMenu.role,
            state: nodeMenu.state,
            feature: nodeMenu.feature,
            formDesignerId: nodeMenu.formDesignerId,
            onlineTableId: nodeMenu.onlineTableId,
            onlineDataId: nodeMenu.onlineDataId,
          }
          break
        case 'rhombus':
          var node = {
