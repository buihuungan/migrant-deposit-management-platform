<template>
  <div ref="node" :style="nodeContainerStyle" @click="clickNode" @mouseup="changeNodeSite">
    <div
      v-if="node.type != 'rectangle' && node.type != 'rhombus' && node.type != 'swinlane' && node.state === 'waiting'"
      style="width: 100%"
    >
    ...
    <div
      v-if="node.type != 'rectangle' && node.type != 'rhombus' && node.type != 'swinlane' && node.state === 'running'"
      style="width: 100%"
    >
    ...
    <div
      v-if="node.type != 'rectangle' && node.type != 'rhombus' && node.type != 'swinlane'  && node.state === 'success'"
      style="width: 100%"
    >
    ...
    <div v-if="node.type === 'rectangle' && node.state === 'waiting'  && !node.hasClicked" style="width: 100%">
      <div class="ef-node-menu-rectangle ef-node-menu-rectangle-waiting flex-col" id="recnode">
        <span class="ef-node-menu-rectangle-text ef-node-menu-rectangle-text-waiting flow-node-drag" id="recnodetext">{{
          node.name
        }}</span>
      </div>
    </div>
    <div v-if="node.type === 'rectangle' && node.state === 'waiting' && node.hasClicked" style="width: 100%">
      <div class="ef-node-menu-rectangle ef-node-menu-rectangle-waiting flex-col node-clicked" id="recnode">
        <span class="ef-node-menu-rectangle-text ef-node-menu-rectangle-text-waiting flow-node-drag" id="recnodetext">{{
          node.name
        }}</span>
      </div>
    </div>
    <div v-if="node.type === 'rectangle' && node.state === 'running'" style="width: 100%">
    ...
    <div v-if="node.type === 'rectangle' && node.state === 'success'" style="width: 100%">
    ...
    <div v-if="node.type === 'rhombus' && node.state === 'success'" style="width: 100%">
    ...
    <div v-if="node.type === 'swinlane'">
      ...
      >
        <div
          ...
          v-if="node.type === 'swinlane' && node.state === 'waiting'"
        >
        ...
        <div
          ...
          v-if="node.state === 'success' && node.state === 'success'"
        >
          <div class="swinlane-outer2 flex-row">
            <img
              class="swinlane-icon"
