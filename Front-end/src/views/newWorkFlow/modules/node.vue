<template>
  <div ref="node" :style="nodeContainerStyle" @click="clickNode" @mouseup="changeNodeSite">
    ...
    <div
      v-if="node.type != 'rectangle' && node.type != 'rhombus' && node.type != 'swinlane' && node.state === 'Completed'"
      style="width: 100%"
    >
    ...
    <div v-if="node.type === 'rectangle' && node.state === 'waiting'" style="width: 100%">
    ...
    <div v-if="node.type === 'rectangle' && node.state === 'Completed'" style="width: 100%">
