          ...
          <a-card :bordered="false" v-if="selectedKeys.length > 0">
            <a-form :form="form">
              ...
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="机构类型">
                <template v-if="orgCategoryDisabled == '1'">
                ...
                <template v-if="orgCategoryDisabled == '2'">
                  <a-radio-group v-decorator="['orgCategory', validatorRules.orgCategory]" placeholder="请选择机构类型">
                    <a-radio value="2"> 部门 </a-radio>
                    <a-radio value="3"> 单位 </a-radio>
                  </a-radio-group>
                </template>
                 <!-- <template v-if="orgCategoryDisabled == '3'">
                <a-radio-group v-decorator="['memo', {}]" placeholder="请选择部门类型">
                  <a-radio value="1">
                    职能部门
                  </a-radio>
                  <a-radio value="0">
  ...
  methods: {
    ...
    batchDel: function () {
      ...
      if (this.checkedKeys.length <= 0) {
        ...
        this.$elementConfirm('确定要删除所选中的 ' + this.checkedKeys.length + ' 条数据，以及子节点数据吗?', '确认删除', {
    ...
    onSelect(selectedKeys, e) {
      ...
      console.log('onSelect-record', record, this.orgTypeList)
    ...
    setValuesToForm(record) {
      if (!record.parentId) {
        this.orgCategoryDisabled='1'
      } else {
        this.orgCategoryDisabled ='2'
        // if(!record.children){
        //   this.orgCategoryDisabled = '3'
        // }
      }
      this.$nextTick(() => {
