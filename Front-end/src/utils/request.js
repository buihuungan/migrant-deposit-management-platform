...
import { ACCESS_TOKEN, TENANT_ID, USER_ID } from "@/store/mutation-types"
 ...
 * @type {*|string}
 */
let apiBaseUrl = window._CONFIG['domianURL'] || "/stj";
  ...
  if (error.response) {
    ...
    switch (error.response.status) {
      ...
      case 500:
        ...
        if(token && data.message.includes("Token失效")&& !url_has_token){
